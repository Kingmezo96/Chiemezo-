...
values
  ...
  ('boys-champions-strategy', 'branding', 'Boys Champions Strategy', 'Branding & Strategy', 'A strategy document branding system created for a youth advocacy organization.', 'assets/portfolio/boys-champions-strategy.jpeg', 'wide', true, true, 6),
